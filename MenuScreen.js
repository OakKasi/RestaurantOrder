        ...
        <View style={styles.popupOverlay}>
          <View style={styles.popupContent}>
            ...
            <View style={styles.qtyRow}>
              <TouchableOpacity style={styles.qtyBtn} onPress={() => setTempQty(Math.max(0, tempQty - 1))}>
                <Text style={styles.qtyBtnText}>-</Text>
              </TouchableOpacity>
              <Text style={styles.qtyVal}>{tempQty}</Text>
              <TouchableOpacity style={styles.qtyBtn} onPress={() => setTempQty(tempQty + 1)}>
                <Text style={styles.qtyBtnText}>+</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.popupActions}>
              ...
              <TouchableOpacity style={[styles.actionBtn, styles.confirmBtn]} onPress={saveToCart}>
